...
@Model.register("selective_tagger_with_lm")
class SelectiveTaggerWithLM(Model):
    """
    ...
    def __init__(self,
        ...
        super(SelectiveTaggerWithLM, self).__init__(vocab, regularizer)
    ...
    def forward(self,  # type: ignore
        ...
        # Index into the encoded_contextualized_representations to
        # get tensors corresponding to the representations of the tokens
        ...
        selected_token_representations = encoded_contextualized_representations[
    ...
    def from_params(cls,
                    vocab: Vocabulary,
                    params: Params) -> 'SelectiveTaggerWithLM':
