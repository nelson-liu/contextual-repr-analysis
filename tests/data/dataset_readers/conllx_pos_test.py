...
class TestConllXPOSDatasetReader():
    data_path = CustomTestCase.FIXTURES_ROOT / "data" / "pos" / "wsj.conllx"
    ...
    def test_reproducible_with_and_without_contextualization(self, lazy, max_instances):
        uncontextualized_params = Params({
            ...
            "lazy": lazy})
        uncontextualized_reader = ConllXPOSDatasetReader.from_params(uncontextualized_params)
        ...
        contextualized_reader = ConllXPOSDatasetReader.from_params(contextualized_params)
