...
class TestSemanticDependencyArcClassification(ModelTestCase):
    def setUp(self):
        super(TestSemanticDependencyArcClassification, self).setUp()
        self.set_up_model(
            self.FIXTURES_ROOT / 'tasks' / 'semantic_dependency_arc_classification' / 'experiment.json',
    ...
    def test_pairwise_tagger_with_contextualizer_can_train_save_and_load(self):
        self.ensure_model_can_train_save_and_load(
            self.FIXTURES_ROOT / 'tasks' / 'semantic_dependency_arc_classification' /
    ...
    def test_no_input_representations_throws_error(self):
        broken_param_file = (self.FIXTURES_ROOT / 'tasks' / 'semantic_dependency_arc_classification' /
