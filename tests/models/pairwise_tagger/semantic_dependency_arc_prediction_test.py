...
class TestSemanticDependencyArcPrediction(ModelTestCase):
    def setUp(self):
        super(TestSemanticDependencyArcPrediction, self).setUp()
        self.set_up_model(self.FIXTURES_ROOT / 'tasks' / 'semantic_dependency_arc_prediction' / 'experiment.json',
    ...
    def test_no_input_representations_throws_error(self):
        broken_param_file = (self.FIXTURES_ROOT / 'tasks' / 'semantic_dependency_arc_prediction' /
