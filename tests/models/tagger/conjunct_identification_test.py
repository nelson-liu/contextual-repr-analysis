...
class TestConjunctIdentificationModel(ModelTestCase):
    def setUp(self):
        super(TestConjunctIdentificationModel, self).setUp()
        self.set_up_model(self.FIXTURES_ROOT / 'tasks' / 'conjunct_identification' / 'experiment.json',
    ...
    def test_simple_tagger_with_contextualizer_can_train_save_and_load(self):
        self.ensure_model_can_train_save_and_load(
            self.FIXTURES_ROOT / 'tasks' / 'conjunct_identification' /
    ...
    def test_no_input_representations_throws_error(self):
        broken_param_file = (self.FIXTURES_ROOT / 'tasks' / 'conjunct_identification' /
