...
class TestCCGSupertagging(ModelTestCase):
    def setUp(self):
        super(TestCCGSupertagging, self).setUp()
        self.set_up_model(self.FIXTURES_ROOT / 'tasks' / 'ccg_supertagging' / 'experiment.json',
    ...
    def test_no_input_representations_throws_error(self):
        broken_param_file = (self.FIXTURES_ROOT / 'tasks' / 'ccg_supertagging' /
