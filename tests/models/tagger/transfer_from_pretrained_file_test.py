...
from contexteval.models import Tagger


class TestTaggerTransferFromPretrainedFile(ModelTestCase):
    def setUp(self):
        super(TestTaggerTransferFromPretrainedFile, self).setUp()
    ...
    def test_tagger_transfer_encoder(self):
        ...
        new_model = Tagger.from_params(vocab=self.vocab, params=params_for_loading)
