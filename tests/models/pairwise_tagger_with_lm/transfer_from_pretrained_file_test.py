...
from contexteval.models import PairwiseTaggerWithLM


class TestPairwiseTaggerWithLanguageModelTransferFromPretrainedFile(ModelTestCase):
    def setUp(self):
        super(TestPairwiseTaggerWithLanguageModelTransferFromPretrainedFile, self).setUp()

    @flaky
    def test_pairwise_tagger_transfer_encoder(self):
        self.set_up_model(
            self.FIXTURES_ROOT / 'tasks' /
            'syntactic_dependency_arc_classification' /
            'experiment_transfer_encoder_language_model.json',
            self.FIXTURES_ROOT / 'data' / 'syntactic_dependency' /
            'ptb.conllu')
        ...
        new_model = PairwiseTaggerWithLM.from_params(
    ...
    @flaky
    def test_pairwise_tagger_transfer_language_model(self):
        self.set_up_model(
            self.FIXTURES_ROOT / 'tasks' /
            'syntactic_dependency_arc_classification' /
            'experiment_transfer_encoder_language_model.json',
    ...
    @flaky
    def test_pairwise_tagger_transfer_encoder_and_language_model(self):
        self.set_up_model(
            self.FIXTURES_ROOT / 'tasks' /
            'syntactic_dependency_arc_classification' /
            'experiment_transfer_encoder_language_model.json',
    ...
    @flaky
    def test_pairwise_tagger_transfer_and_freeze_language_model(self):
        self.set_up_model(
            self.FIXTURES_ROOT / 'tasks' /
            'syntactic_dependency_arc_classification' /
            'experiment_transfer_encoder_language_model.json',
