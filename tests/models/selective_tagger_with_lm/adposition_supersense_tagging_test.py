...
class TestAdpositionSupersenseTaggingWithLanguageModel(ModelTestCase):
    def setUp(self):
        super(TestAdpositionSupersenseTaggingWithLanguageModel, self).setUp()
        self.set_up_model(
    ...
    def test_selective_tagger_with_lm_can_train_save_and_load(self):
