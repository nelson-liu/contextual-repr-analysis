...
from contexteval.models import SelectiveTaggerWithLM


class TestSelectiveTaggerWithLanguageModelTransferFromPretrainedFile(ModelTestCase):
    def setUp(self):
        super(TestSelectiveTaggerWithLanguageModelTransferFromPretrainedFile, self).setUp()

    @flaky
    def test_selective_tagger_transfer_encoder(self):
        self.set_up_model(
            self.FIXTURES_ROOT / 'tasks' / 'adposition_supersense_tagging' /
            'experiment_transfer_encoder_language_model.json',
            self.FIXTURES_ROOT / 'data' / 'adposition_supersenses' /
            'streusle.json')
        ...
        new_model = SelectiveTaggerWithLM.from_params(
    ...
    @flaky
    def test_selective_tagger_transfer_language_model(self):
        self.set_up_model(
            self.FIXTURES_ROOT / 'tasks' / 'adposition_supersense_tagging' /
            'experiment_transfer_encoder_language_model.json',
            self.FIXTURES_ROOT / 'data' / 'adposition_supersenses' /
    ...
    @flaky
    def test_selective_tagger_transfer_encoder_and_language_model(self):
        self.set_up_model(
            self.FIXTURES_ROOT / 'tasks' / 'adposition_supersense_tagging' /
            'experiment_transfer_encoder_language_model.json',
            self.FIXTURES_ROOT / 'data' / 'adposition_supersenses' /
    ...
    @flaky
    def test_selective_tagger_transfer_and_freeze_language_model(self):
        self.set_up_model(
            self.FIXTURES_ROOT / 'tasks' / 'adposition_supersense_tagging' /
            'experiment_transfer_encoder_language_model.json',
            self.FIXTURES_ROOT / 'data' / 'adposition_supersenses' /
