...
from contexteval.models import SelectiveRegressor


class TestSelectiveRegressorTransferFromPretrainedFile(ModelTestCase):
    def setUp(self):
        super(TestSelectiveRegressorTransferFromPretrainedFile, self).setUp()
    ...
    def test_tagger_transfer_encoder(self):
        ...
        new_model = SelectiveRegressor.from_params(vocab=self.vocab, params=params_for_loading)
